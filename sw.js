...
var SHELL_CACHE='japan-map-shell-v10';
...
self.addEventListener('fetch',function(e){
  ...
  if(url.indexOf('nominatim.openstreetmap.org')>-1||url.indexOf('google.com')>-1||url.indexOf('googleapis.com')>-1||url.indexOf('gstatic.com')>-1||url.indexOf('ggpht.com')>-1)return;
  e.respondWith(
