...
var SHELL_CACHE='japan-map-shell-v28';
...
self.addEventListener('fetch',function(e){
  ...
  if(url.indexOf('nominatim.openstreetmap.org')>-1||url.indexOf('open-meteo.com')>-1||url.indexOf('frankfurter')>-1||url.indexOf('wikipedia.org')>-1||url.indexOf('wikidata.org')>-1||url.indexOf('supabase.co')>-1||url.indexOf('google.com')>-1||url.indexOf('googleapis.com')>-1||url.indexOf('gstatic.com')>-1||url.indexOf('ggpht.com')>-1)return;
  e.respondWith(
